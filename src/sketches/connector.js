...
// Sketch One
export default function sketch (p) { // p could be any variable name
    ...
    var Particle = function(position) {
      this.acceleration = p.createVector(0, -0.02);
    ...
    ParticleSystem.prototype.addParticle = function() {
      this.particles.push(new Particle(p.createVector(p.random(p.canvas.width), p.random(p.canvas.width))));
    }
